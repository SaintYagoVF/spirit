...
public class PerfilActivity extends AppCompatActivity {
    ...
    EditText filtrarClientes;

    Integer idPasado;

    FloatingActionButton fabCliente;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabCliente=(FloatingActionButton) findViewById(R.id.fabCliente);
        ...
        filtrarClientes = (EditText)findViewById(R.id.filtroClientes);
        ...
        */
        ...
        listViewClientes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                ...
                Cliente user=listaClientes.get(pos);
              //  String nom=user.getIdentificacionCliente();

               // String keyword = user.toString();
                Integer index = -1;
                for (int i = 0; i < listaClientes.size(); i++) {
                    if (listaClientes.get(i).getNombreCliente().equals(nombr)) {
                        index = i;
                ...
                Cliente user34=listaClientes.get(index);


                Intent intent=new Intent(PerfilActivity.this,DetalleClienteActivity.class);

                Bundle bundle=new Bundle();
                bundle.putSerializable("cliente",user34);

               // Toast.makeText(PerfilActivity.this, "Nueva posición: "+nombr, Toast.LENGTH_SHORT).show();


                String informacion="CLIENTE: "+nombr+"\n";
        ...
        fabCliente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(PerfilActivity.this, "Registrar Cliente", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(PerfilActivity.this, RegistrarClienteActivity.class);
        ...
        filtrarClientes.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (PerfilActivity.this).adaptador.getFilter().filter(s);
            }
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.productos:
                                ...
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent = new Intent(PerfilActivity.this, ClienteActivity.class);
                                intent.putExtras(basket);
                                startActivity(intent);
                                finish();
                                return true;
                            case R.id.carrito:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent2 = new Intent(PerfilActivity.this, CarritoActivity.class);
                            ...
                            case R.id.stock:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent3 = new Intent(PerfilActivity.this, StockActivity.class);
                            ...
                            case R.id.perfil:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent4 = new Intent(PerfilActivity.this, PerfilActivity.class);
                            ...
                            case R.id.micuenta:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent6 = new Intent(PerfilActivity.this, CuentaActivity.class);
                            ...
                            case R.id.logout:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent5 = new Intent(PerfilActivity.this, LoginActivity.class);
                                        ...
                                        switch (which){
                                            case DialogInterface.BUTTON_POSITIVE:
                                                ...
                                                if(connectivityDetector.checkConnectivityStatus()){
                                                    ...
                                                    connectivityDetector.showAlertDialog(PerfilActivity.this, "ACTIVE EL WI-FI","No hay conexión a Internet");
                                                }
