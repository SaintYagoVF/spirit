...
public class CuentaActivity extends AppCompatActivity {
   ...
   TextView usuarioEmpleado;

    TextView codigoEmpleado;

    TextView nombresEmpleado;

    TextView apellidosEmpleado;

    TextView identificacionEmpleado;

    TextView profesionEmpleado;

    TextView domicilioEmpleado;

    TextView telfdomicilioEmpleado;

    TextView celularEmpleado;

    TextView emailEmpleado;

    TextView extoficinaEmpleado;

    TextView nivelEmpleado;

    TextView estadoEmpleado;


    TextView tipocuentaEmpleado;

    TextView numcuentaEmpleado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarioEmpleado=(TextView)findViewById(R.id.simpleTextView12);
        codigoEmpleado=(TextView)findViewById(R.id.simpleTextView22);
        nombresEmpleado=(TextView)findViewById(R.id.simpleTextView32);
        apellidosEmpleado=(TextView)findViewById(R.id.simpleTextView42);
        identificacionEmpleado=(TextView)findViewById(R.id.simpleTextView52);
        profesionEmpleado=(TextView)findViewById(R.id.simpleTextView62);
        domicilioEmpleado=(TextView)findViewById(R.id.simpleTextView72);
        telfdomicilioEmpleado=(TextView)findViewById(R.id.simpleTextView82);
        celularEmpleado=(TextView)findViewById(R.id.simpleTextView92);
        emailEmpleado=(TextView)findViewById(R.id.simpleTextView102);
        extoficinaEmpleado=(TextView)findViewById(R.id.simpleTextView112);
        nivelEmpleado=(TextView)findViewById(R.id.simpleTextView122);
        estadoEmpleado=(TextView)findViewById(R.id.simpleTextView132);
        tipocuentaEmpleado=(TextView)findViewById(R.id.simpleTextView142);
        numcuentaEmpleado=(TextView)findViewById(R.id.simpleTextView152);
    ...
    private void inicializarTabla(String valorPasado) {


        SQLiteDatabase db=conn.getReadableDatabase();
        String[] parametros={valorPasado};

        try {
            //select nombre,telefono from usuario where codigo=?
            Cursor cursor=db.rawQuery("SELECT "+Utilidades.CAMPO_USUARIO_EMPLEADO+","+Utilidades.CAMPO_CODIGO_EMPLEADO+","+Utilidades.CAMPO_NOMBRES_EMPLEADO+","+Utilidades.CAMPO_APELLIDOS_EMPLEADO+","+Utilidades.CAMPO_IDENTIFICACION_EMPLEADO+","+Utilidades.CAMPO_PROFESION_EMPLEADO+","+Utilidades.CAMPO_DOMICILIO_EMPLEADO+","+Utilidades.CAMPO_TELFDOMICILIO_EMPLEADO+","+Utilidades.CAMPO_CELULAR_EMPLEADO+","+Utilidades.CAMPO_EMAIL_EMPLEADO+","+Utilidades.CAMPO_EXTOFICINA_EMPLEADO+","+Utilidades.CAMPO_NIVEL_EMPLEADO+","+Utilidades.CAMPO_ESTADO_EMPLEADO+","+Utilidades.CAMPO_TIPOCUENTA_EMPLEADO+","+Utilidades.CAMPO_NUMCUENTA_EMPLEADO+
                    " FROM "+Utilidades.TABLA_EMPLEADO+" WHERE "+Utilidades.CAMPO_IDENTIFICACION_EMPLEADO+"=? ",parametros);

            cursor.moveToFirst();
            usuarioEmpleado.setText(cursor.getString(0));
            codigoEmpleado.setText(cursor.getString(1));
            nombresEmpleado.setText(cursor.getString(2));
            apellidosEmpleado.setText(cursor.getString(3));
            identificacionEmpleado.setText(cursor.getString(4));
            profesionEmpleado.setText(cursor.getString(5));
            domicilioEmpleado.setText(cursor.getString(6));
            telfdomicilioEmpleado.setText(cursor.getString(7));
            celularEmpleado.setText(cursor.getString(8));
           emailEmpleado.setText(cursor.getString(9));
            extoficinaEmpleado.setText(cursor.getString(10));
            nivelEmpleado.setText(cursor.getString(11));
            estadoEmpleado.setText(cursor.getString(12));
            tipocuentaEmpleado.setText(cursor.getString(13));
            numcuentaEmpleado.setText(cursor.getString(14));



                Log.d("Usuario",usuarioEmpleado.getText().toString());
            ...
            Toast.makeText(getApplicationContext(),"Error al iniciar tabla",Toast.LENGTH_LONG).show();
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.productos:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent = new Intent(CuentaActivity.this, ClienteActivity.class);
                            ...
                            case R.id.carrito:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent2 = new Intent(CuentaActivity.this, CarritoActivity.class);
                            ...
                            case R.id.stock:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent3 = new Intent(CuentaActivity.this, StockActivity.class);
                            ...
                            case R.id.perfil:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent4 = new Intent(CuentaActivity.this, PerfilActivity.class);
                            ...
                            case R.id.micuenta:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent6 = new Intent(CuentaActivity.this, CuentaActivity.class);
                            ...
                            case R.id.logout:
                                ...
                                Toast.makeText(CuentaActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                                mDrawerLayout.closeDrawer(GravityCompat.START);
                                Intent intent5 = new Intent(CuentaActivity.this, LoginActivity.class);
                                        ...
                                        switch (which){
                                            case DialogInterface.BUTTON_POSITIVE:
                                                ...
                                                if(connectivityDetector.checkConnectivityStatus()){
                                                    ...
                                                    connectivityDetector.showAlertDialog(CuentaActivity.this, "ACTIVE EL WI-FI","No hay conexión a Internet");
                                                }
